...
namespace RMERP.Controllers
{
    ...
    public class WageRegisterController : Controller
    {
        ...
        //public async Task<FileResult> WageRegisterNewExcel2(int WAG_Id, int FRM_Id)
        //{
        //    SessionUtils sessionUtils = new(Request, Response);
        //    WageRegisterManager wageRegisterManager = new(_context);
        //    List<ClientWageRegisterVM> List = [];
        //    if (WAG_Id > 0)
        ...
        //    DateTime wageMonth = DAL.Helpers.ProjectUtils.DateToDateTime(wage_Process.WAG_Month);
        ...
        //            if (client.Attendance.Where(m => m.CLI_Id.Equals(client.client.CLI_Id)).Any())
        //            {
        ...
        //                    decimal Final_TotalOutStation = 0M, Final_TotalAttendance = 0M, Final_TotalNightshift = 0M, Final_TotalPerformance = 0M, Final_TotalLWF = 0M; decimal Final_TotalEarnedBasic = 0M, Final_TotalEarnedHRA = 0M, Final_TotalGrossWagePayble = 0M, Final_TotalAdvance = 0M, Final_TotalProfTax = 0M, Final_TotalPF = 0M, Final_TotalESIC = 0M, Final_TotalOtherDeduction = 0M, Final_TotalNetWagesPaid = 0M;

        //                    List<WageAllowancesTotalVM> WageAllowancesTotalVMs = [];
        //                    //added on 26th oct 2020
        //                    List<CustomAllowanceVM> allowanceVMs = [];
        ...
        //                    string[] all6 = clientReqs.Select(m => m.CRI_Allowance_Name_6).Distinct().ToArray();
        //                    string[] all7 = clientReqs.Select(m => m.CRI_Allowance_Name_7).Distinct().ToArray();
        //                    string[] all8 = clientReqs.Select(m => m.CRI_Allowance_Name_8).Distinct().ToArray();
        //                    string[] all9 = clientReqs.Select(m => m.CRI_Allowance_Name_9).Distinct().ToArray();
        //                    string[] all10 = clientReqs.Select(m => m.CRI_Allowance_Name_10).Distinct().ToArray();

        //                    List<string> allCustomAallownces = [.. all1.ToList(), .. all2.ToList(), .. all3.ToList(), .. all4.ToList(), .. all5.ToList(), .. all6.ToList(), .. all7.ToList(), .. all8.ToList(), .. all9.ToList(), .. all10.ToList()];
        ...
        //                    allowanceVMs.AddRange(allCustomAallownces.Distinct().Where(m => m != null).Select(all =>
        //                    new CustomAllowanceVM()
        //                    {
        //                        DES_Id = 0,
        //                        C_ALL_Title = all,
        //                        C_ALL_Value = 0
        ...
        //                        decimal TotalEarnedBasic = 0M, TotalEarnedHRA = 0M, TotalGrossWagePayble = 0M, TotalAdvance = 0M, TotalProfTax = 0M, TotalPF = 0M, TotalESIC = 0M, TotalMLWF = 0M, TotalOtherDeduction = 0M, TotalNetWagesPaid = 0M;
        ...
        //                            TotalEarnedBasic = TotalEarnedBasic + employee.WAR_Basic_Calculated + employee.WAR_DA_Calculated;
        //                            cellEmp30.CellStyle = styleGrey25;

        //                            cellEmpCount = cellEmpCount + 1;
        //                            ICell cellEmp31 = row.CreateCell(cellEmpCount); //Earned HRA
        //                            TotalEarnedHRA = TotalEarnedHRA + employee.WAR_HRA_Calculated;
        ...
        //                                }
        //                                else
        //                                if (employee.clientRequirementVM.CRI_Allowance_Name_6 == allownce.C_ALL_Title)
        //                                {
        //                                    WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_6 != null ? employee.WAR_Allowance_Calculated_6.Value : 0, MidpointRounding.AwayFromZero);
        //                                    cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
        //                                    TotalAllowance6 = TotalAllowance6 + WAR_Allowance_Calculated;
        //                                    allownce.C_ALL_Value = allownce.C_ALL_Value + WAR_Allowance_Calculated;
        //                                }
        //                                else
        //                                if (employee.clientRequirementVM.CRI_Allowance_Name_7 == allownce.C_ALL_Title)
        //                                {
        //                                    WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_7 != null ? employee.WAR_Allowance_Calculated_7.Value : 0, MidpointRounding.AwayFromZero);
        //                                    cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
        //                                    TotalAllowance7 = TotalAllowance7 + WAR_Allowance_Calculated;
        //                                    allownce.C_ALL_Value = allownce.C_ALL_Value + WAR_Allowance_Calculated;
        //                                }
        //                                else
        //                                if (employee.clientRequirementVM.CRI_Allowance_Name_8 == allownce.C_ALL_Title)
        //                                {
        //                                    WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_8 != null ? employee.WAR_Allowance_Calculated_8.Value : 0, MidpointRounding.AwayFromZero);
        //                                    cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
        //                                    TotalAllowance8 = TotalAllowance8 + WAR_Allowance_Calculated;
        //                                    allownce.C_ALL_Value = allownce.C_ALL_Value + WAR_Allowance_Calculated;
        //                                }
        //                                else
        //                                if (employee.clientRequirementVM.CRI_Allowance_Name_9 == allownce.C_ALL_Title)
        //                                {
        //                                    WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_9 != null ? employee.WAR_Allowance_Calculated_9.Value : 0, MidpointRounding.AwayFromZero);
        //                                    cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
        //                                    TotalAllowance9 += WAR_Allowance_Calculated;
        //                                    allownce.C_ALL_Value += WAR_Allowance_Calculated;
        //                                }
        //                                else
        //                                if (employee.clientRequirementVM.CRI_Allowance_Name_10 == allownce.C_ALL_Title)
        //                                {
        //                                    WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_10 != null ? employee.WAR_Allowance_Calculated_10.Value : 0, MidpointRounding.AwayFromZero);
        //                                    cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
        //                                    TotalAllowance10 += WAR_Allowance_Calculated;
        //                                    allownce.C_ALL_Value += WAR_Allowance_Calculated;
        //                                }
        //                                else
        //                                {
        ...
        //                            TotalGrossWagePayble = TotalGrossWagePayble + Math.Round(employee.WAR_GrossTotal, MidpointRounding.AwayFromZero);
        ...
        //                            TotalPF = TotalPF + employee.WAR_PF_Calculated;
        ...
        //                            TotalESIC = TotalESIC + employee.WAR_ESIC_Calculated;
        ...
        //                            TotalOtherDeduction = TotalOtherDeduction + DeductTotal;
        ...
        //                            TotalNetWagesPaid = TotalNetWagesPaid + employee.WAR_FinalTotal;
        ...
        //                    int ftotalCount = totalAttCols + 9 + 10;
        ...
        //                    fcellTot3s.SetCellValue("-");
        //                    fcellTot3s.CellStyle = styleTotal;

        //                    int fk = 0;
        //                    int fcellAllow = ftotalCount + 3;
        ...
        //                        fcellEmpAll.CellStyle = styleTotal;
        ...
        //                        fcellEmpAlls.CellStyle = styleTotal;
        //                        fcellAllow++;
        //                        fk++;
        //                    }
        ...
        //                        ftotalCount = ftotalCount + 1;
        //                        ICell cellTot_Allowance_1 = frow.CreateCell(ftotalCount);
        //                        cellTot_Allowance_1.CellStyle = styleTotal;
        ...
        //                    //    cellTot5s.CellStyle = styleTotal;
        ...
        //                    fcellTotGrosss.SetCellValue("-");
        //                    fcellTotGrosss.CellStyle = styleTotal;

        //                    ICell fcellTotgwp = frow.CreateCell(ftotalCount + 2);
        //                    fcellTotgwp.SetCellValue("Total Gross Wages Payable");
        //                    fcellTotgwp.CellStyle = styleTotal;
        //                    ICell fcellTotgwps = frowSecond.CreateCell(ftotalCount + 2);
        ...
        //                    ICell fcellTotAdvance = frow.CreateCell(ftotalCount + 3);
        //                    fcellTotAdvance.SetCellValue("Total Advance");
        //                    fcellTotAdvance.CellStyle = styleTotal;
        //                    ICell fcellTotAdvances = frowSecond.CreateCell(ftotalCount + 3);
        ...
        //                    ICell fcellTotProff = frow.CreateCell(ftotalCount + 4);
        //                    fcellTotProff.SetCellValue("Total Profit/Income Tax/PT");
        //                    fcellTotProff.CellStyle = styleTotal;
        //                    ICell fcellTotProffs = frowSecond.CreateCell(ftotalCount + 4);
        ...
        //                    ICell fcellTotMLWF = frow.CreateCell(ftotalCount + 7);
        ...
        //                    ICell fcellTotOtherDeds = frowSecond.CreateCell(ftotalCount + 8);
        ...
        //                    ICell fcellTotTotDed = frow.CreateCell(ftotalCount + 9);
        //                    fcellTotTotDed.SetCellValue("Total Deduction");
        //                    fcellTotTotDed.CellStyle = styleTotal;
        //                    ICell fcellTotTotDeds = frowSecond.CreateCell(ftotalCount + 9);
        ...
        //                    ICell fcellTotNetWagesPaid = frow.CreateCell(ftotalCount + 10);
        //                    fcellTotNetWagesPaid.SetCellValue("Total Net Wages Paid");
        //                    fcellTotNetWagesPaid.CellStyle = styleTotal;
        //                    ICell fcellTotNetWagesPaids = frowSecond.CreateCell(ftotalCount + 10);
        ...
        public async Task<FileResult> WageRegisterExcel2(int WAG_Id, int FRM_Id)
        {
            WageProcessManager wageProcess = new(_context);
            ...
            using (var fs = new FileStream(Path.Combine(newPath, fileName), FileMode.Create, FileAccess.Write))
            {
                IWorkbook workbook = new XSSFWorkbook();
                ISheet excelSheet = null;
                //List<Wage_Process_Client> cs = WageProcessManager.GetWage_Process_Clients(wage_Process.WAG_Id);
                foreach (var client in wage_Process.Wage_Process_Clients.OrderBy(c=>c.CLI.CLI_RegisteredOn))
                {
                    ...
                    foreach (int CRI_Id in CRI_Ids)
                    {
                        ...
                        foreach (Wage_Register wage_register in wage_registers)
                        {
                            ...
                            ICell cellEmp7 = row.CreateCell(7);
                            cellEmp7.SetCellValue(DateHelper.getDateWithFormat(new DateTime(wage_register.EMP.EMP_DateOfJoining.Year, wage_register.EMP.EMP_DateOfJoining.Month, wage_register.EMP.EMP_DateOfJoining.Day)));
                            cellEmp7.CellStyle = styleGrey25;
        ...
        //if (WAG_Id > 0)
        //{
        //    List = wageRegisterManager.GenerateWageClientsRegisterTable(WAG_Id, sessionUtils.GetLoggedAdminID(), FRM_Id);
        //}

        //ReportsManager manager = new ReportsManager(_context);
        //WageProcessManager wageProcess = new WageProcessManager(_context);
        //Wage_Process wage_Process = wageProcess.GetWageProcessByWAG_Id(WAG_Id, true, true, true, true);
        ...
        //    ISheet excelSheet = null;
        //    foreach (var client in List.Select(m => new { m.client, m.wageProcessClientVM, m.wageProcessVM.Attendance_Summaries }).Distinct())
        //    {
        //        if (client.Attendance_Summaries.Where(m => m.CLI_Id.Equals(client.client.CLI_Id)).Count() > 0)
        //        {
        //            string sheetName = client.client.CLI_Id.ToString() + "-" + WorkbookUtil.CreateSafeSheetName((client.client.CLI_Name.ToString().Length > 20 ? client.client.CLI_Name.ToString().Substring(0, 20) : client.client.CLI_Name.ToString()));
        //            excelSheet = workbook.CreateSheet(sheetName);
        //            foreach (var item in List.Where(m => m.client.CLI_Id.Equals(client.client.CLI_Id)))
        ...
        public async Task<FileResult> WageRegisterExcel_1(int WAG_Id, int FRM_Id)
        {
            ...
            DateTime wageMonth = ProjectUtils.DateToDateTime(wage_Process.WAG_Month);
            string WAG_Month = wageMonth.ToString("MMMM").ToUpper() + "-" + wageMonth.ToString("yyyy");
                            ...
                            foreach (var dd in distinceDesignations)
                            {
                                ...
                                foreach (var employee in wageRegisters)
                                {
                                    ...
                                    foreach (string allownce in allCustomAallownces.Distinct().Where(m => m != null))
                                    {
                                        ...
                                        if (employee.clientRequirementVM.CRI_Allowance_Name_6 == allownce)
                                        {
                                            WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_6.Value, MidpointRounding.AwayFromZero);
                                            cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
                                            TotalAllowance6 += WAR_Allowance_Calculated;
                                        }
                                        else
                                        if (employee.clientRequirementVM.CRI_Allowance_Name_7 == allownce)
                                        {
                                            WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_7.Value, MidpointRounding.AwayFromZero);
                                            cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
                                            TotalAllowance7 += WAR_Allowance_Calculated;
                                        }
                                        else
                                        if (employee.clientRequirementVM.CRI_Allowance_Name_8 == allownce)
                                        {
                                            WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_8.Value, MidpointRounding.AwayFromZero);
                                            cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
                                            TotalAllowance8 += WAR_Allowance_Calculated;
                                        }
                                        else
                                        if (employee.clientRequirementVM.CRI_Allowance_Name_9 == allownce)
                                        {
                                            WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_9.Value, MidpointRounding.AwayFromZero);
                                            cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
                                            TotalAllowance9 += WAR_Allowance_Calculated;
                                        }
                                        else
                                        if (employee.clientRequirementVM.CRI_Allowance_Name_10 == allownce)
                                        {
                                            WAR_Allowance_Calculated = Math.Round(employee.WAR_Allowance_Calculated_10.Value, MidpointRounding.AwayFromZero);
                                            cellCustom.SetCellValue(WAR_Allowance_Calculated.ToString());
                                            TotalAllowance10 += WAR_Allowance_Calculated;
                                        }
                                        else
                ...
                foreach (var client in List.Select(m => new { m.client, m.wageProcessClientVM, m.wageProcessVM.Attendance }).Distinct())
                {
                    ...
                    if (client.Attendance.Where(m => m.CLI_Id.Equals(client.client.CLI_Id)).Count() > 0)
                    {
                        ...
                        foreach (var item in List.Where(m => m.client.CLI_Id.Equals(client.client.CLI_Id)))
                        {
                            ...
                            decimal Final_TotalOutStation = 0M, Final_TotalAttendance = 0M, Final_TotalNightshift = 0M, Final_TotalPerformance = 0M, Final_TotalLWF = 0M;
                            decimal Final_TotalAllowance1 = 0M, Final_TotalAllowance2 = 0M, Final_TotalAllowance3 = 0M, Final_TotalAllowance4 = 0M, Final_TotalAllowance5 = 0M;
                            decimal Final_TotalEarnedBasic = 0M, Final_TotalEarnedHRA = 0M, Final_TotalGrossWagePayble = 0M, Final_TotalAdvance = 0M, Final_TotalProfTax = 0M, Final_TotalPF = 0M, Final_TotalESIC = 0M, Final_TotalMLWF = 0M, Final_TotalOtherDeduction = 0M, Final_TotalNetWagesPaid = 0M;
                            ...
                            string[] all4 = clientReqs.Select(m => m.CRI_Allowance_Name_4).Distinct().ToArray();
                            string[] all5 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
                            string[] all6 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
                            string[] all7 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
                            string[] all8 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
                            string[] all9 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
                            string[] all10 = clientReqs.Select(m => m.CRI_Allowance_Name_5).Distinct().ToArray();
