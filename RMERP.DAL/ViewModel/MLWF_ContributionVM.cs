...
namespace RMERP.DAL.ViewModel
{
    public class MLWF_ContributionVM
    {
        ...
        //public int EMP_CONTR_BELOW_3K { get; set; } //RS.6
        //public int EMP_CONTR_ABOVE_3K { get; set; } //RS.12
        //public int EMPLOYER_CONTR_BELOW_3K { get; set; } //RS.18
        //public int EMPLOYER_CONTR_ABOVE_3K { get; set; } //RS.36
