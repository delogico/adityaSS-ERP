	...
	public class ReportsManager
	{
			...
			foreach (var client in PFClientList)
			{
				...
				foreach (var register in wage_Register)
				{
					...
					decimal TotalMonthlyWages = GetAmountBasedOnFormula_Report(
						...
						register.WAR_HRA_Calculated,
						register.WAR_LeaveAndPH_Calculated,
						 register.Wage_Register_Allowances.ToList(),
		...
		public EmployeePaySlipVM GeneratePaySlip(int WAG_Id, int EMP_Id)
		{
			...
			foreach (Wage_Register wage in wage_Registers)
			{
				...
				WAR_LeaveAndPH_Calculated = WAR_LeaveAndPH_Calculated + wage.WAR_LeaveAndPH_Calculated;
			...
			paySlipVM.WAR_LeaveAndPH_Calculated = WAR_LeaveAndPH_Calculated;
