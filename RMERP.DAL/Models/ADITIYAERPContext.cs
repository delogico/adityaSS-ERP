...
public partial class ADITIYAERPContext : DbContext
{
    public ADITIYAERPContext()
    {
    }

    public ADITIYAERPContext(DbContextOptions<ADITIYAERPContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=ADITIYAERP;User Id=sa;Password=Perfect;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Client_Requirement>(entity =>
        {
            ...
            entity.Property(e => e.CRI_LeaveAndPH_Fixed).HasColumnType("decimal(9, 2)");
        ...
        modelBuilder.Entity<Wage_Register>(entity =>
        {
            ...
            entity.Property(e => e.WAR_LeaveAndPH).HasColumnType("decimal(9, 2)");
            entity.Property(e => e.WAR_LeaveAndPH_Calculated).HasColumnType("decimal(9, 2)");
